        ...
        <>
            {/* <Box p={20} pb={50}>
                ...
                <div  onClick={() => toggle(!open)}>
                    <animated.svg  style={{ scale, opacity }} viewBox="-950 -200 3278 746">
                        <defs>
                            <filter id="water">
            ...
            <Box p={20}>
                ...
                <Box p={20} className='ibarra' fontSize={17}>
                    ...
                    <p>My name is Allyson Vitug and a <span> &lt; Full Stack Web Developer /&gt; </span> from Anaheim, CA. </p>
                    <p>I am very passionate when it comes to designing webpages and love finding the perfect color palette that match the websites I create.</p>
                </Box>
